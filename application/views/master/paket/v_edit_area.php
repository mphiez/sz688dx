	  ...
	  <div class="modal-dialog" style="display:show;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<form method='post' action="<?=base_url().'index.php/master/proses_edit_area';?>" enctype="multipart/form-data">
					<div class="form-group has-success col-lg-6"  id="c_user_id">
					  ...
					  <input type="text" class="form-control" id="nm_area" name='nm_area' placeholder="Masukan Nama area" value="<?=$nama?>">
					  <input type="hidden" class="form-control" id="id" name='id' placeholder="Masukan Nama area" value="<?=$id?>">
					</div>
